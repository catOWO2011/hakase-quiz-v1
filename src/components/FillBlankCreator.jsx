  ...
  return (
    <div>
      ...
      <div className="flex flex-wrap bg-white border-2 border-solid border-[#d6d6d6] px-[5px] pt-[5px] pb-0">
        <ul className="inline-flex flex-wrap m-0 p-0 w-full">
          ...
          <li className="bg-none grow p-0 flex mr-[5px] mb-[5px] items-center">
            {showInput && (
              <input
                ...
                className="overflow-visi4ble w-full p-[5px] focus:border-[#00A9FF] focus:border-teal focus:outline-none focus:ring-0 bg-[#CDF5FD]"
                ref={inputRef}
              />
            )}
          </li>
